...
/**
 * Self-contained notification-preferences experience. Rendered both by the
 * standalone `/settings/notifications` route (variant="page") and by the
 * Notifications tab on the Settings page (variant="tab").
 */
export function NotificationsPanel({ variant = "page" }: { variant?: PanelVariant }) {
    ...
    <div className="space-y-6">
      {variant === "page" ? (
        ...
        <div className="min-w-0">
          <SectionTitle className="text-lg sm:text-xl animate-fade-down">Notifications</SectionTitle>

...
import UserInputNode from "./io/userInputNode";
import { USER_INPUT_NODE_DEFINITION } from "./io/definitions";
...
export const registerAllNodeTypes = () => {
  ...
  nodeRegistry.registerNodeType(USER_INPUT_NODE_DEFINITION);
};

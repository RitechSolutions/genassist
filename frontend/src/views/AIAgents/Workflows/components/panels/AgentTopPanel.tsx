    ...
    return (
        <>
          ...
          <AgentFormDialog
            ...
            data={{id: data?.id, name: data?.name, description: data?.description, welcome_message: data?.welcome_message, welcome_title: data?.welcome_title, input_disclaimer_html: data?.input_disclaimer_html, thinking_phrase_delay: data?.thinking_phrase_delay, possible_queries: data?.possible_queries, thinking_phrases: data?.thinking_phrases, greet_on_start: data?.greet_on_start, greeting_prompt: data?.greeting_prompt}}
          />
        </>
      );

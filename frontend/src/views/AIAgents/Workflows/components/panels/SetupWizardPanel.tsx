  ...
  return (
    <div className="fixed bottom-20 left-4 z-30 w-80 animate-fade-up">
      ...
      <div className="rounded-2xl border border-border bg-card shadow-xl shadow-black/5 overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-ai-brand/5 to-ai-brand-light/5 border-b border-border">
          ...
          <button
            onClick={onClose}
            className="h-6 w-6 rounded-md flex items-center justify-center text-muted-foreground hover:text-muted-foreground hover:bg-muted transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="p-2 space-y-1 max-h-80 overflow-y-auto">
          {steps.map((step) => (
            <button
              ...
              className="w-full flex items-center gap-3 rounded-xl px-3 py-2.5 text-left transition-all duration-150 hover:bg-muted group"
            >
        ...
        {allDone && (
          <div className="px-4 py-3 bg-green-50 border-t border-green-100 dark:bg-green-500/15 dark:border-green-500/30 space-y-2">

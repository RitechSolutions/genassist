...
class ConversationAnalysisService:
    ...
    async def create_conversation_analysis(self, gpt_analysis: AnalysisResult, llm_analyst_id: UUID,
        ...
        conversation_analysis_create = ConversationAnalysisCreate(conversation_id=conversation_id, topic=topic,
                ...
                negative_sentiment=gpt_analysis.kpi_metrics.get("Sentiment", {}).get("negative", 0), tone=tone,
                llm_analyst_id=llm_analyst_id, efficiency=gpt_analysis.kpi_metrics.get("Efficiency", 0),

...
def memory_trimming_fields(max_messages_default: int = 10) -> List[FieldSchema]:
    """Memory-trimming config shared by agentNode and subAgentNode.
    Both nodes run the same history-trimming logic
    """
    return [
        FieldSchema(

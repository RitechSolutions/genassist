...
from app.api.v1.routes.prompt_editor import NodeIdPath, PromptFieldPath, router
...
@pytest.mark.parametrize("annotation,max_length", [(NodeIdPath, 100), (PromptFieldPath, 50)])
def test_path_ids_are_bounded_at_their_column_widths(annotation, max_length):
